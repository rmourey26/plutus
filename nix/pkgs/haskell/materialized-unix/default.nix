  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "hspec-discover".revision = (((hackage."hspec-discover")."2.7.9").revisions).default;
        ...
        "sbv".revision = (((hackage."sbv")."8.14").revisions).default;
        ...
        "hspec".revision = (((hackage."hspec")."2.7.9").revisions).default;
